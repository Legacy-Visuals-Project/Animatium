...
public final class SuperSecretButton extends Button.Plain {
	...
	public void playDownSound(SoundManager soundManager) {
		...
		sounds.add(SoundEvents.GRASS_HIT);
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("random.fizz")).orElse(null).value());
...
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.zombiepig.zpigangry")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.slime.small")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("minecart.base")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.ghast.fireball")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.villager.haggle")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("game.neutral.hurt.fall.small")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("game.player.hurt.fall.big")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.zombie.infect")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.blaze.breathe")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.wolf.whine")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("game.player.hurt.fall.small")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.silverfish.step")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("game.hostile.hurt.fall.big")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.irongolem.throw")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.horse.land")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.horse.skeleton.hit")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.magmacube.jump")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.chicken.say")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.villager.idle")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.horse.idle")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("random.levelup")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.wolf.death")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.skeleton.say")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("game.hostile.swim")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("creeper.primed")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("random.break")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.wolf.growl")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("step.gravel")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.horse.skeleton.idle")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("random.bow")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.wolf.shake")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.cat.meow")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.horse.hit")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.cat.purreow")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.cow.say")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("step.grass")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("step.wood")).orElse(null).value());
...
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.zombiepig.zpig")).orElse(null).value());
...
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.zombie.remedy")).orElse(null).value());
		sounds.add(SoundEvents.LIGHTNING_BOLT_THUNDER);
		sounds.add(SoundEvents.ZOMBIE_HURT);
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("mob.wolf.howl")).orElse(null).value());
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("game.hostile.hurt.fall.small")).orElse(null).value());
...
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("random.pop")).orElse(null).value());
		sounds.add(SoundEvents.FIRECHARGE_USE);
//		sounds.add(BuiltInRegistries.SOUND_EVENT.get(Identifier.withDefaultNamespace("random.successful_hit")).orElse(null).value());
		sounds.add(SoundEvents.HORSE_GALLOP);
