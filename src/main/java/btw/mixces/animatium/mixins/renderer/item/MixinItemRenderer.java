...
//    }
    ...
    // TODO: Fix
//    @WrapOperation(method = "renderQuadList", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/resources/model/BakedModel;getQuads(Lnet/minecraft/world/level/block/state/BlockState;Lnet/minecraft/core/Direction;Lnet/minecraft/util/RandomSource;)Ljava/util/List;", ordinal = 1))
...
//        if (AnimatiumClient.getEnabled() && animatium$isTransformationModeValid() && !instance.usesBlockLight()) {
